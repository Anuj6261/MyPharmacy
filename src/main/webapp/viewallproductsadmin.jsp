...
prefix = "c" %>
       ...
       <c:set var = "massage" value=""/>
       
	  <c:if test="${param.msg == 'Deletionfailed'}">

     <c:set var="massage" value=" deletion  failed"/>
	...
	<c:set var = "massage" value=""/>
	  ...
	  <c:if test="${param.msg == 'Updationfailed'}">

     <c:set var="massage" value=" UpdationFailed failed"/>
